...
public class PgpUtils {
    ...
    private static String privatePGPKey = "";
    private static String publicPGPKey = "";

    private static final String PROVIDER = "SC";
    private static final String KEY_RING_ID = "pablo_ramirez@migesa.com.mx";
    ...
    public static String decrypt(String encryptedText, String password) throws Exception {
        ...
        while (sKey == null && enc.getEncryptedDataObjects().hasNext()) {
            ...
            sKey = getPrivateKey(secretKeyRing, pbe.getKeyID(), password.toCharArray());
        }
    ...
    private static PGPPublicKeyRing getPGPPublicKeyRing() throws IOException {
        ArmoredInputStream ais = new ArmoredInputStream(new ByteArrayInputStream(getPublicPGPKey().getBytes()));
    ...
    private static PGPSecretKeyRing getPGPSecretKeyRing() throws IOException {
        ArmoredInputStream ais = new ArmoredInputStream(new ByteArrayInputStream(getPrivatePGPKey().getBytes()));
    ...
    public static String getPrivatePGPKey() {
        return privatePGPKey;
    }

    public static void setPrivatePGPKey(String privatePGPKey) {
        PgpUtils.privatePGPKey = privatePGPKey;
    }

    public static String getPublicPGPKey() {
        return publicPGPKey;
    }

    public static void setPublicPGPKey(String publicPGPKey) {
        PgpUtils.publicPGPKey = publicPGPKey;
    }
